...
// utils
	...
	function bool( o ) { switch( n8iv_type( o ) ) {
		case F    : return F;
		case BOOL : return o;
		case NUM  : return o !== 0 && !isNaN( o );
		case STR  : return !booleans.some( function( v ) { return v === o; } );
	...
	function def( item, name, desc, overwrite, debug ) {
		...
		if ( overwrite === T || !exists ) return Object.defineProperty( item, name, desc );
		else if ( debug === T && exists ) {
			trace(); error( new Error( 'Trying to overwrite existing property: ' + name + ', in: ' + ( isFn( item ) ? item.n8ivName : item[CTOR].n8ivName ) + '.' ), T );
		}
		return n8iv;
	}
	...
	function error( e, chuck ) {
		var msg;
		switch( n8iv_type( e ) ) {
			case ERR : msg = e.message;                       break;
			case STR : msg = String( e ); e = new Error( e ); break;
		}
	...
	function exists( o ) { return o !== N && o !== U && ( typeof o == NUM ? !isNaN( o ) : T ); }
	...
	function n8iv_obj( o, n ) { return ( n = Object.create( N ) ) && arguments[LEN] >= 1 ? copy( n, o ) : n; }
...
// type methods
	function __type__() {
		var ctor = this[CTOR], nt = nativeType( this ),
	...
	function n8iv_type( o ) { return o === N || o === U ? F : o[TYPE] || ( n8iv_proto( o ) === N ? NOBJ : U ); }
	...
	function isBool( o )   { return n8iv_type( o ) == BOOL; }
	function isEmpty( o )  { switch ( n8iv_type( o ) ) {
		case ARR : return !o[LEN];
		case NUM : return isNaN( o );
		case OBJ : return !Object.len( o );
		case STR : return o === '';
		default  : return !exists( o );
	} }
	function isFn( fn )    { return typeof fn == FN; }
	function isNum( o )    { return n8iv_type( o ) == NUM && !isNaN( o ); }
	function isObj( o, exclusive ) {
		var t = n8iv_type( o );
		return ( t == OBJ && nativeType( o ) == OBJ ) || ( exclusive !== T && t == NOBJ );
	}
	function isStr( o )    { return n8iv_type( o ) == STR; }
...
**/
	def( OP, TYPE, copy( { get : __type__ }, modes.r ) );
	...
	defs( Object, {
		...
		len    : function ( o ) { return Object.keys( o )[LEN]; },
	...
	def( Array[PROTO], 'find', describe( function( fn, ctx ) {
		var i = -1, l = this[LEN] >>> 0; ctx || ( ctx = this );
